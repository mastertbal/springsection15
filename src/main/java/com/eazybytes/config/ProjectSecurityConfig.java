...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.oauth2ResourceServer(rsc -> // rsc means resource server configuration
                rsc.jwt( jwtConfigurer -> jwtConfigurer.jwtAuthenticationConverter(jwtAuthenticationConverter))
        ); // rsc means resource server configuration
...
//        // password will not be erased in the authentication object
